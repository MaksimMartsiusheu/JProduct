...
import com.jhipster.service.ProductService;
import com.jhipster.service.dto.ProductCriteria;
import com.jhipster.service.ProductQueryService;
...
public class ProductResourceIT {
    ...
    private static final Long SMALLER_CATEGORY_ID = 0L - 1L;
    ...
    @Test
    @Transactional
    public void getAllProductsByCategoryIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where categoryId not equals to DEFAULT_CATEGORY_ID
        defaultProductShouldNotBeFound("categoryId.notEquals=" + DEFAULT_CATEGORY_ID);

        // Get all the productList where categoryId not equals to UPDATED_CATEGORY_ID
        defaultProductShouldBeFound("categoryId.notEquals=" + UPDATED_CATEGORY_ID);
    }
    ...
    public void getAllProductsByCategoryIdIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the productList where categoryId is greater than or equal to DEFAULT_CATEGORY_ID
        defaultProductShouldBeFound("categoryId.greaterThanOrEqual=" + DEFAULT_CATEGORY_ID);

        // Get all the productList where categoryId is greater than or equal to UPDATED_CATEGORY_ID
        defaultProductShouldNotBeFound("categoryId.greaterThanOrEqual=" + UPDATED_CATEGORY_ID);
    }

    @Test
    @Transactional
    public void getAllProductsByCategoryIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where categoryId is less than or equal to DEFAULT_CATEGORY_ID
        defaultProductShouldBeFound("categoryId.lessThanOrEqual=" + DEFAULT_CATEGORY_ID);

        // Get all the productList where categoryId is less than or equal to SMALLER_CATEGORY_ID
        defaultProductShouldNotBeFound("categoryId.lessThanOrEqual=" + SMALLER_CATEGORY_ID);
    }
    ...
    public void getAllProductsByCategoryIdIsLessThanSomething() throws Exception {
        ...
        // Get all the productList where categoryId is less than DEFAULT_CATEGORY_ID
        defaultProductShouldNotBeFound("categoryId.lessThan=" + DEFAULT_CATEGORY_ID);

        // Get all the productList where categoryId is less than UPDATED_CATEGORY_ID
        defaultProductShouldBeFound("categoryId.lessThan=" + UPDATED_CATEGORY_ID);
    }

    @Test
    @Transactional
    public void getAllProductsByCategoryIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where categoryId is greater than DEFAULT_CATEGORY_ID
        defaultProductShouldNotBeFound("categoryId.greaterThan=" + DEFAULT_CATEGORY_ID);

        // Get all the productList where categoryId is greater than SMALLER_CATEGORY_ID
        defaultProductShouldBeFound("categoryId.greaterThan=" + SMALLER_CATEGORY_ID);
    }


    @Test
    @Transactional
    public void getAllProductsByVendorIsEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);
        ...
        // Get all the productList where vendor equals to vendorId
        defaultProductShouldBeFound("vendorId.equals=" + vendorId);

        // Get all the productList where vendor equals to vendorId + 1
        defaultProductShouldNotBeFound("vendorId.equals=" + (vendorId + 1));
    }
